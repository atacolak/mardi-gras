	...
	return []helpSection{
		...
		},
		{
			...
			bindings: []helpBinding{
				...
				{key: "e", desc: "Collapse / expand all epics"},
				{key: "E", desc: "Scope to selected epic"},
				{key: "S", desc: "Cycle epic sort: attention / priority / chronological"},
				{key: "s", desc: "Cycle bead sort: attention / priority / chronological"},
				{key: "click ID", desc: "Open a mentioned bead in the detail pane"},
				{key: "ctrl on ID or row", desc: "Preview a mentioned bead or a parade row (wheel/j/k scroll; gap click closes; 2 deep)"},
		...
		},
		{
			...
			bindings: []helpBinding{
				...
				{key: ":", desc: "Palette: sling selected with a formula"},
			},
		},
		{
			title: "DETAIL",
		...
		},
		{
			...
			bindings: []helpBinding{
				...
				{key: ":", desc: "Palette: sling with a formula"},
